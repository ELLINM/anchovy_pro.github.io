...
<input type="hidden" name="action" value="login">
  <h2>로그인</h2>
		<p>
			<label for="adminId" class="floatLabel">ID : </label>
			<input id="adminId" name="adminId" value="${adminId}" type="text">
			<br><font color="red">${message}</font>
		</p>
		<p>
			<label for="adminPw" class="floatLabel">PW : </label>
			<input id="adminPw" name="adminPw" value="${adminPw}"type="password">
		</p>
		<p>
